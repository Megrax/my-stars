...
- [wolfcon/RIP-HLTV-BET](https://github.com/wolfcon/RIP-HLTV-BET) - RIP BET AD (For Tampermonkey) https://greasyfork.org/en/scripts/423484-rip-hltv-bet
...
- [javierbyte/emoji-to-scale](https://github.com/javierbyte/emoji-to-scale) - Your favorite emojis. To real-life scale, more or less.
...
- [fei-aiart/ca-gan](https://github.com/fei-aiart/ca-gan) - CA-GAN: Composition-Aided GANs, IEEE TCYB, 2020
...
- [amodm/webbrowser-rs](https://github.com/amodm/webbrowser-rs) - Rust library to open URLs in the web browsers available on a platform
...
- [MCSManager/UI](https://github.com/MCSManager/UI) - Provides a Web UI for MCSManager 9.X to display data, terminals, tables, i18n, settings, and more.
